...
class Autentifikasi extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata(
                    'pesan',
                    '<div class="alert alert-danger alert-message" role="alert">User Tidak Aktif!!</div>'
                );
                redirect('autentifikasi');
            }
        } else {
    ...
    public function logout()
    {
        ...
        $this->session->set_flashdata(
            'pesan',
            '<div class="alert alert-danger alert-message" role="alert">User Anda Telah Logout!!</div>'
        );
        redirect('autentifikasi');
    }
